    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="text-center mb-5 text-dark">Register a new agencies</div>
                <div class="card my-5">
                    ...
                    <form class="card-body cardbody-color p-lg-5" method="POST"
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Agency name" value="{{ old('name') }}">
                        ...
                        <div id="emailHelp" class="form-text text-center mb-5 text-dark">Already have account ? <a
                                href="{{ route('vendors.login') }}" class="text-dark fw-bold"> Log in now</a>
                        </div>
                    </form>
                </div>
